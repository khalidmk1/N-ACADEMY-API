                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                            <div class="card bg-light d-flex flex-fill">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="lead"><b>{{$manager->user->firstName . ' ' .$manager->lastName}}</b></h2>
                                            <p class="text-muted text-sm"><b>Role: {{$manager->role->role_name}} </b>  </p>
                                ...
                                <div class="card-footer">
                                    <div class="text-right">
                                        <a href="{{Route('dashboard.profile.edit' , Crypt::encrypt($manager->user->id))}}" class="btn btn-sm bg-warning">
                                            <img src="{{ asset('asset/update_icon.png') }}" style="height: 18px;"
                                                    alt="update_icon">
                                        </a>
                                         <button type="button" data-toggle="modal" data-target="#delete_admin_{{$manager->id}}" class="btn btn-sm btn-danger">
